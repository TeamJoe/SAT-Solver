...
list<Methods*>* GetSortList()
{
	...
	*/
	...
	sortList->push_back(new Methods("Score-3", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::MostClauseCountLargestToSmallest, Sorter::MostDifference));
	...
	sortList->push_back(new Methods("ScoreQuick-1", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::MostClauseCountSmallestToLargest, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-2", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::MostClauseCountSmallestToLargest, Sorter::LeastDifference));
	sortList->push_back(new Methods("ScoreQuick-3", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::MostClauseCountLargestToSmallest, Sorter::MostDifference));

	sortList->push_back(new Methods("ScoreQuick-4", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-5", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-6", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-7", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-8", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-9", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-10", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::LeastDifference));
	sortList->push_back(new Methods("ScoreQuick-11", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostAbsoluteScore, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargeUsed, Sorter::LeastDifference));
#endif
#endif
