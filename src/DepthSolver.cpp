...
public:
	...
	Methods(const char* name, Sorter v1, Sorter v2, Sorter v3, Sorter v4, Sorter v5, Sorter v6, Sorter v7, Sorter v8, Sorter v9, Sorter v10, Sorter v11) {
		this->name = name;
		sorters = new Sorter[12];
		sorters[0] = v1;
		sorters[1] = v2;
		sorters[2] = v3;
		sorters[3] = v4;
...
list<Methods*>* GetSortList()
{
	...
	*/
	...
	sortList->push_back(new Methods("LargeToSmall-1", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostClauseCountLargestToSmallest, Sorter::MostDifference));
	/*
	...
	*/
	...
	sortList->push_back(new Methods("Score-1", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::MostClauseCountSmallestToLargest, Sorter::MostDifference));
	sortList->push_back(new Methods("Score-2", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::MostClauseCountSmallestToLargest, Sorter::LeastDifference));
	sortList->push_back(new Methods("Score-3", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::MostClauseCountLargestToSmallest, Sorter::MostDifference));

	sortList->push_back(new Methods("Score-4", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("Score-5", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("Score-6", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("Score-7", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("Score-8", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("Score-9", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("Score-10", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::LeastDifference));
	sortList->push_back(new Methods("Score-11", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargeUsed, Sorter::LeastDifference));

	sortList->push_back(new Methods("ScoreQuick-1", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::MostClauseCountSmallestToLargest, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-2", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::MostClauseCountSmallestToLargest, Sorter::LeastDifference));
	sortList->push_back(new Methods("ScoreQuick-3", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::MostClauseCountLargestToSmallest, Sorter::MostDifference));

	sortList->push_back(new Methods("ScoreQuick-4", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-5", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-6", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::MostLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-7", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastDifference, Sorter::LeastLargeUsed));
	sortList->push_back(new Methods("ScoreQuick-8", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-9", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::LeastLargeUsed, Sorter::MostDifference));
	sortList->push_back(new Methods("ScoreQuick-10", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostLargeUsed, Sorter::LeastDifference));
	sortList->push_back(new Methods("ScoreQuick-11", Sorter::HasNoSolution, Sorter::HasRequired, Sorter::HasQuickPath, Sorter::MostPercent1Score, Sorter::LeastSmallestClauseSize, Sorter::MostSmallestClauseCount, Sorter::LeastLargestClauseSize, Sorter::LeastLargestClauseCount, Sorter::MostTotalUsed, Sorter::LeastLargeUsed, Sorter::LeastDifference));
#endif
#endif
