...
enum class VariableSoltuions { VARIABLE_NO_SOLUTION = 0x7FFFFFFF, MUST_NEGATIVE = -2, VARIABLE_NEGATIVE = -1, VARIABLE_UNKNOWN = 0, VARIABLE_POSITIVE = 1, MUST_POSITIVE = 2 };
